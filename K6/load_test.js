...
export let options = {
    ...
    stages: [
        { duration: '5m', target: 100 }, // simulate ramp-up of traffic from 1 to 100 users over
        { duration: '100', target: 100 }, // stay at 100 users for 10 minutes
        { duration: '5m', target: 0 }, // ramp-down to o users
    ],
    thresholds: {
        http_req_duration: ['p(99)<150'], // 99% of requests must complete bel W 15695.
    }
};
...
export default () => {
    http.post('https://dev-jmeta-ner.simplify-ai.com/v1/job/entities',
        {
            "text_list": [
